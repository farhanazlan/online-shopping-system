					...
					<div class="col-md-12">
						...
						<div class="newsletter">
							...
							<ul class="newsletter-follow">
								<li>
									<a href="https://www.facebook.com/Bundle-Planet-103315924662306/"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://twitter.com/NajibRazak"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href="https://www.instagram.com/bundleplanet_/"><i class="fa fa-instagram"></i></a>
								</li>
